...
详见 [AlphaSense](../02_公司调研/AlphaSense.md) · [Bloomberg](../02_公司调研/Bloomberg_与BloombergGPT.md) · [BlackRock](../02_公司调研/BlackRock_Aladdin_AI.md) · [JPMorgan](../02_公司调研/JPMorgan_COIN_IndexGPT.md)
...
**同板块深度**：
- [大模型在投研侧的应用现状](大模型在投研侧的应用现状.md)
- [AI 量化与传统量化的异同](AI量化_与传统量化的异同.md)
- [金融大模型的监管与合规](金融大模型的监管与合规.md)

**公司级**：
- [BlackRock Aladdin AI](../02_公司调研/BlackRock_Aladdin_AI.md) · [Bloomberg 与 BloombergGPT](../02_公司调研/Bloomberg_与BloombergGPT.md)
- [JPMorgan COIN / IndexGPT](../02_公司调研/JPMorgan_COIN_IndexGPT.md) · [蚂蚁 支小宝 / 百灵](../02_公司调研/蚂蚁_支小宝_百灵.md)
...
- [IndexGPT (JPM)](../03_产品调研/IndexGPT_JPM.md)
